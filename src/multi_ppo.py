...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy2",
        reward=False,
        policy=True,
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy3",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy4",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy5",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy6",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy7",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
...
ppo = PPO(
        "hyperparams.json",
        result_file="data/doorkey_big_policy8",
        reward=False,
        policy=True,
        consigliere=consigliere,
    )
